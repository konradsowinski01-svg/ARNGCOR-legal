...
1.2. Usługę świadczy SovinSky Studio (dalej: "Usługodawca", "my"). Kontakt: konrad.sowinski01@gmail.com.

1.3. Korzystanie z Aplikacji polega na zawarciu umowy o świadczenie usług drogą elektroniczną na warunkach niniejszego Regulaminu oraz Polityki prywatności (osobny dokument w Aplikacji). W razie sprzeczności co do danych osobowych pierwszeństwo ma Polityka prywatności.
...
- Treść cyfrowa - m.in. plany ćwiczeń, nagrania wideo, nagrania audio, programy (np. codzienna praktyka, wyzwanie Mostek, sekwencje ulga w bólu).
...
4.2. Treść w Aplikacji ma charakter edukacyjno-rekreacyjny i informacyjny. Nie zastępuje konsultacji z lekarzem, fizjoterapeutą lub innym specjalistą, diagnozy, leczenia ani rehabilitacji.

4.3. Użytkownik ćwiczy na własne ryzyko i odpowiedzialność. W przypadku bólu, urazu, choroby przewlekłej, ciąży, po operacji lub innych wątpliwości zdrowotnych - przed ćwiczeniami skonsultuj się ze specjalistą i przestrzegaj jego zaleceń.

4.4. W razie nagłego, silnego lub nietypowego bólu, zawrotów głowy, duszności lub innych niepokojących objawów przerwij ćwiczenia i w razie potrzeby szukaj pomocy medycznej. Aplikacja nie służy do sytuacji nagłych.
...
5.2. Użytkownik chroni dane logowania i urządzenie. Nie udostępnia Konta osobom trzecim. Informuje nas o podejrzeniu nieautoryzowanego dostępu.

5.3. Możesz połączyć metody logowania w ustawieniach zgodnie z funkcjami Aplikacji. Zakazane jest obchodzenie zabezpieczeń, tworzenie wielu kont w celu nadużycia okresu próbnego lub limitów.
...
- wprowadzanie złośliwego oprogramowania, ataki na systemy;
- podawanie nieprawdziwych danych w celu oszukańczego dostępu do Premium lub promocji;
- naruszanie praw autorskich, znaków towarowych lub dóbr osobistych Usługodawcy lub osób trzecich;
- wykorzystywanie Aplikacji do celów bezprawnych.
...
7.2. Użytkownik otrzymuje niewyłączną, niezbywalną licencję na korzystanie z Treści cyfrowej wyłącznie na własny użytek osobisty, niekomercyjny, na czas posiadania prawa dostępu (Konto / Premium), w zakresie funkcji Aplikacji.
...
8.2. Premium i zakupy dodatkowe (np. odblokowanie wyzwania Mostek - jeśli oferowane jako jednorazowy zakup) realizowane są przez Apple App Store na iOS. Płatności, faktury, odnowienia i zwroty regulują warunki Apple (w tym Media Services Terms / zasady subskrypcji Apple). Usługodawca nie pobiera danych kart płatniczych.

8.3. Ceny, okres rozliczeniowy i zakres Premium są wyświetlane w Aplikacji przed zakupem. Subskrypcja może odnawiać się automatycznie do czasu anulowania w ustawieniach konta Apple (co najmniej 24 h przed końcem okresu - zgodnie z zasadami Apple).

8.4. Przywrócenie zakupów - funkcja w Aplikacji / App Store służy do odzyskania uprawnień na urządzeniu powiązanym z Apple ID.
...
- odpowiedzialność odszkodowawcza Usługodawcy wobec Użytkownika nie będącego konsumentem ograniczona jest do wysokości opłat faktycznie zapłaconych na rzecz Usługodawcy za Aplikację w okresie 12 miesięcy poprzedzających zdarzenie, z wyjątkiem szkody wyrządzonej umyślnie;
- wobec konsumenta ograniczenia stosuje się tylko w zakresie dozwolonym przez art. 385¹ KC i inne bezwzględne przepisy oraz ustawę o prawach konsumenta.
...
10.2. Usługodawca odpowie w rozsądnym terminie, nie dłużej niż wynika to z przepisów o konsumentach (co do zgodności usługi cyfrowej).
...
12.2. Dalsze korzystanie po terminie wejścia zmian w życie oznacza akceptację, o ile prawo nie wymaga wyraźnej ponownej zgody.
...
14.2. Regulamin wchodzi w życie z dniem publikacji wskazanej jako wersja dokumentu.

14.3. Korzystając z ARNGCOR, potwierdzasz, że rozumiesz ograniczenia medyczne Usługi i akceptujesz warunki powyższe.
